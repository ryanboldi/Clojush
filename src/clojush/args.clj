...
(def push-argmap
  (atom (sorted-map
         ...
         :weighted-lexicase-bias :average
          ;; If using weighted-lexicase, the chosen bias to weight by. Options are :number-of-zeros, :average, :number-of-nonzeros, :number-of-nonzeros-inverse, :variance, :variance-inverse, :number-of-zeros-inverse, :median, :median-inverse
