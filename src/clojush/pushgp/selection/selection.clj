...
(defn select
  ...
  (let [pop-with-meta-errors (map #(update-in % [:errors] (comp vec concat) (:meta-errors %)) pop)
        ...
        selected (case parent-selection
                   ...
                   :weighted-lexicase (weighted-lexicase-selection preselected argmap)
                   :bias-lexicase (bias-lexicase-selection preselected argmap)
                   :ranked-lexicase (ranked-lexicase-selection preselected argmap)
